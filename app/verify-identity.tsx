        ...
        {verified ? (
          <View style={styles.doneCard}>
            <View style={styles.doneIcon}>
              <MaterialIcons name="verified-user" size={42} color={PHANX.green} />
            </View>
          ...
          <>
            ...
            <View style={styles.docRow}>
              ...
              >
                <MaterialIcons
                  name="badge"
                  size={22}
                  color={docType === "id" ? PHANX.green : PHANX.ink}
                />
              ...
              >
                <MaterialIcons
                  name="menu-book"
                  size={22}
                  color={docType === "passport" ? PHANX.green : PHANX.ink}
                />
            ...
            {preview ? (
              ...
              >
                <MaterialIcons name="photo-camera" size={28} color={PHANX.muted} />
            ...
            >
              <MaterialIcons name="verified" size={18} color={PHANX.white} />
...
const styles = StyleSheet.create({
  ...
  title: { color: PHANX.ink, fontSize: 18, fontWeight: "900" },
  hint: {
    color: PHANX.muted,
    fontSize: 12,
    lineHeight: 20,
  ...
  docBtnActive: { borderColor: PHANX.green, backgroundColor: PHANX.greenSoft },
  docText: { color: PHANX.ink, fontSize: 12, fontWeight: "800" },
  docTextActive: { color: PHANX.green },
  uploadBox: {
    borderWidth: 1,
    borderColor: PHANX.line,
    borderStyle: "dashed",
  ...
  uploadText: { color: PHANX.muted, fontSize: 12, fontWeight: "700" },
  ...
  changeText: { color: PHANX.green, fontSize: 12, fontWeight: "800" },
  confirmBtn: {
    height: 52,
    borderRadius: 14,
  ...
  confirmText: { color: PHANX.white, fontSize: 14, fontWeight: "900" },
  doneCard: {
