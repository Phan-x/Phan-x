...
import { Card, CoinMark, PhanLogo, IconButton, StatusPill } from "@/components/phanx-ui";
...
function FearGauge({ score }: { score: number }) {
  ...
  const color =
    score >= 75 ? "#E07A2F" : score >= 55 ? PHANX.green : score >= 40 ? PHANX.gold : PHANX.red;
  return (
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.content}>
        ...
        <Card style={styles.hero}>
          <View style={styles.heroIcon}>
            <MaterialIcons name="auto-awesome" size={22} color={PHANX.green} />
          </View>
          ...
          >
            ...
            <View style={styles.assetName}>
              ...
              <Text style={styles.assetPrice}>
                {item.price} · <Text style={{ color: item.change.startsWith("-") ? PHANX.red : PHANX.green }}>{item.change}</Text>
              </Text>
            </View>
        ...
        <Card style={styles.detailCard}>
          ...
          <View style={styles.levels}>
            ...
            <View style={styles.levelBox}>
              ...
              <Text style={[styles.levelValue, { color: PHANX.green }]}>{asset.score}%</Text>
            </View>
          </View>

          <Meter label="زخم الشراء" value={asset.momentum} color={PHANX.green} />
          <Meter label="نشاط الحجم" value={asset.volume} color={PHANX.purple} />
          <Meter label="التذبذب" value={asset.volatility} color={PHANX.gold} />

          <View style={styles.assetTip}>
            <MaterialIcons name="tips-and-updates" size={18} color={PHANX.gold} />
...
const styles = StyleSheet.create({
  ...
  kicker: { color: PHANX.muted, textAlign: "right", fontSize: 12 },
  title: { color: PHANX.ink, textAlign: "right", fontSize: 28, fontWeight: "900", marginTop: 4 },
  subtitle: { color: PHANX.muted, textAlign: "right", fontSize: 12, marginTop: 6, marginBottom: 16, lineHeight: 18 },
  hero: {
    flexDirection: "row",
    alignItems: "center",
  ...
  heroTitle: { color: PHANX.ink, fontSize: 13, fontWeight: "800", textAlign: "right" },
  heroSub: { color: PHANX.muted, fontSize: 10, marginTop: 4, textAlign: "right" },
  heroScore: { color: PHANX.green, fontWeight: "900", fontSize: 16 },
  ...
  tfChipActive: { backgroundColor: PHANX.green, borderColor: PHANX.green },
  tfText: { color: PHANX.muted, fontSize: 12, fontWeight: "800" },
  tfTextActive: { color: PHANX.white },
  ...
  gaugeTitle: { color: PHANX.ink, fontSize: 13, fontWeight: "800", textAlign: "right" },
  gaugeSub: { color: PHANX.muted, fontSize: 10, marginTop: 3, textAlign: "right" },
  gaugeScore: { fontSize: 22, fontWeight: "900", minWidth: 40, textAlign: "left" },
  gaugeTrack: { height: 10, borderRadius: 8, backgroundColor: PHANX.surface, overflow: "hidden" },
  gaugeFill: { height: "100%", borderRadius: 8 },
  gaugeLegend: { flexDirection: "row", justifyContent: "space-between", marginTop: 6 },
  gaugeLegendText: { color: PHANX.muted, fontSize: 10 },
  sectionLabel: { color: PHANX.ink, fontWeight: "800", fontSize: 16, textAlign: "right", marginBottom: 10 },
  assetRow: {
    flexDirection: "row",
    alignItems: "center",
    gap: 10,
  ...
  assetName: { flex: 1 },
  assetSymbol: { color: PHANX.ink, fontSize: 13, fontWeight: "800", textAlign: "right" },
  assetPrice: { color: PHANX.muted, fontSize: 10, marginTop: 3, textAlign: "right" },
  signal: { alignItems: "flex-end", gap: 5 },
  signalScore: { color: PHANX.muted, fontSize: 9 },
  ...
  detailTitle: { color: PHANX.ink, fontSize: 16, fontWeight: "900", textAlign: "right" },
  detailSub: { color: PHANX.muted, fontSize: 11, marginTop: 3, textAlign: "right" },
  ...
  levelLabel: { color: PHANX.muted, fontSize: 10, marginBottom: 4 },
  levelValue: { color: PHANX.ink, fontSize: 12, fontWeight: "900" },
  meter: { marginBottom: 10 },
  meterTop: { flexDirection: "row-reverse", justifyContent: "space-between", marginBottom: 4 },
  meterLabel: { color: PHANX.muted, fontSize: 11 },
  meterValue: { color: PHANX.ink, fontSize: 11, fontWeight: "800" },
  meterTrack: { height: 8, borderRadius: 6, backgroundColor: PHANX.surface, overflow: "hidden" },
  ...
  assetTipText: { flex: 1, color: PHANX.ink, fontSize: 11, lineHeight: 17, textAlign: "right" },
  tipCard: { marginBottom: 14 },
  tipHeader: { flexDirection: "row-reverse", alignItems: "center", gap: 8, marginBottom: 8 },
  tipTitle: { color: PHANX.ink, fontSize: 13, fontWeight: "900", flex: 1, textAlign: "right" },
  tipText: { color: PHANX.muted, fontSize: 12, lineHeight: 18, textAlign: "right" },
  tipDots: { flexDirection: "row", justifyContent: "center", gap: 6, marginTop: 12 },
  dot: { width: 7, height: 7, borderRadius: 4, backgroundColor: PHANX.line },
  dotActive: { backgroundColor: PHANX.green, width: 16 },
  note: {
    flexDirection: "row",
  ...
  noteCopy: { flex: 1 },
  noteTitle: { color: PHANX.ink, fontWeight: "800", textAlign: "right", fontSize: 12 },
  noteText: { color: PHANX.muted, fontSize: 11, lineHeight: 17, textAlign: "right", marginTop: 4 },
  pressed: { opacity: 0.6 },
});
