    ...
    <ScreenContainer className="px-5" edges={["top", "left", "right"]}>
      ...
      {status === "unsupported" || status === "denied" ? (
        <View style={styles.fallback}>
          <MaterialIcons name="videocam-off" size={40} color={PHANX.muted} />
...
const styles = StyleSheet.create({
  ...
  frame: { position: "absolute", top: 60, width: 220, height: 220, borderWidth: 3, borderColor: PHANX.green, borderRadius: 20 },
  hint: { color: PHANX.muted, fontSize: 12, marginTop: 16, textAlign: "center" },
  fallback: { alignItems: "center", paddingTop: 60, paddingHorizontal: 10 },
  fallbackTitle: { color: PHANX.ink, fontSize: 14, fontWeight: "900", marginTop: 16, textAlign: "center" },
  fallbackSub: { color: PHANX.muted, fontSize: 12, marginTop: 10, textAlign: "center", lineHeight: 19 },
  backBtn: { backgroundColor: PHANX.green, borderRadius: 14, paddingHorizontal: 22, paddingVertical: 13, marginTop: 22 },
  backBtnText: { color: PHANX.white, fontSize: 12, fontWeight: "800" },
});
