...
import { IconButton } from "@/components/phanx-ui";
    ...
    try {
      ...
      if (qrUri) {
        try {
          ...
          const file = new File([blob], "phanx-address-qr.png", { type: "image/png" });
      ...
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        ...
        {address ? (
          !showConfirm ? (
            ...
            >
              <MaterialIcons name="check-circle-outline" size={17} color={PHANX.white} />
            ...
            <View style={styles.selectorsRow}>
              ...
              <View style={styles.selectorCol}>
                ...
                <Pressable onPress={() => router.push("/network-select")} style={styles.selectorPill}>
                  ...
                  <MaterialIcons name="unfold-more" size={14} color={PHANX.muted} />
                </Pressable>
              </View>
            </View>
            ...
            <View style={styles.qrCard}>
              <View style={styles.qrBrandRow}>
                <Pressable onPress={handleShare} hitSlop={8}>
                  <MaterialIcons name="ios-share" size={20} color={PHANX.ink} />
                </Pressable>
                <View style={{ alignItems: "flex-end" }}>
                  <Text style={styles.brand}>Phan-x</Text>
              ...
              {!address ? (
                <View style={styles.noAddress}>
                  <MaterialIcons name="error-outline" size={30} color={PHANX.muted} />
                ...
                <>
                  ...
                  <Pressable onPress={copyAddress} style={({ pressed }) => [styles.copyBtn, pressed && styles.pressed]}>
                    <MaterialIcons name="content-copy" size={16} color={PHANX.green} />
...
const styles = StyleSheet.create({
  ...
  selectorPill: { flexDirection: "row-reverse", alignItems: "center", gap: 6, backgroundColor: PHANX.surface, borderRadius: 12, paddingHorizontal: 10, height: 42 },
  selectorValue: { color: PHANX.ink, fontSize: 13, fontWeight: "800", flex: 1, textAlign: "right" },
  qrCard: { backgroundColor: PHANX.surface, borderRadius: 22, padding: 18, alignItems: "center" },
  qrBrandRow: { flexDirection: "row", justifyContent: "space-between", alignItems: "center", width: "100%", marginBottom: 16 },
  brand: { color: PHANX.ink, fontSize: 20, fontWeight: "900" },
  brandSub: { color: PHANX.muted, fontSize: 9, fontWeight: "700", letterSpacing: 1, marginTop: 2 },
  ...
  addressLabel: { color: PHANX.muted, fontSize: 10, marginBottom: 8 },
  address: { color: PHANX.green, fontSize: 13, fontWeight: "800", textAlign: "center", lineHeight: 20 },
  copyBtn: { flexDirection: "row-reverse", alignItems: "center", gap: 6, marginTop: 14, backgroundColor: "#fff", borderRadius: 12, paddingHorizontal: 16, paddingVertical: 9, borderWidth: 1, borderColor: PHANX.line },
  copyBtnText: { color: PHANX.green, fontSize: 12, fontWeight: "800" },
  noAddress: { alignItems: "center", paddingVertical: 40, gap: 10 },
  noAddressText: { color: PHANX.muted, fontSize: 12, textAlign: "center", paddingHorizontal: 20 },
  noteRow: { flexDirection: "row-reverse", gap: 8, marginTop: 18, paddingHorizontal: 4 },
  note: { flex: 1, color: PHANX.muted, fontSize: 10.5, lineHeight: 17, textAlign: "right" },
  pressed: { opacity: 0.6 },
  sentBtn: {
  ...
  sentBtnText: { color: PHANX.white, fontSize: 13, fontWeight: "800" },
  confirmBox: {
  ...
  confirmLabel: { color: PHANX.ink, fontSize: 12, fontWeight: "800", textAlign: "center", marginBottom: 10 },
  confirmInput: { backgroundColor: "#fff", borderRadius: 12, borderWidth: 1, borderColor: PHANX.line, height: 46, fontSize: 15, fontWeight: "800", color: PHANX.ink },
  confirmHint: { color: PHANX.muted, fontSize: 10, textAlign: "center", marginTop: 10, lineHeight: 16 },
  confirmActions: { flexDirection: "row", gap: 8, marginTop: 14 },
  confirmCancel: { flex: 1, height: 44, borderRadius: 12, borderWidth: 1, borderColor: PHANX.line, alignItems: "center", justifyContent: "center" },
  confirmCancelText: { color: PHANX.ink, fontSize: 12, fontWeight: "800" },
  confirmSubmit: { flex: 2, height: 44, borderRadius: 12, backgroundColor: PHANX.green, alignItems: "center", justifyContent: "center" },
  confirmSubmitText: { color: PHANX.white, fontSize: 12, fontWeight: "800" },
});
