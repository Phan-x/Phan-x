...
const styles = StyleSheet.create({
  ...
  card: { gap: 4 },
  label: { color: PHANX.ink, fontSize: 12, fontWeight: "800", textAlign: "right", marginBottom: 8, marginTop: 14 },
  inputRow: {
    flexDirection: "row",
    alignItems: "center",
    gap: 8,
  ...
  input: { flex: 1, color: PHANX.ink, fontSize: 13, height: "100%" },
  submit: {
    marginTop: 26,
    height: 52,
    borderRadius: 14,
  ...
  submitText: { color: PHANX.white, fontSize: 14, fontWeight: "900" },
  pressed: { opacity: 0.7 },
});
