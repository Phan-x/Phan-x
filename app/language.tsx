        ...
        <Card>
          {options.map((opt, i) => (
            ...
            >
              ...
              {locale === opt.code && <MaterialIcons name="check-circle" size={20} color={PHANX.green} />}
            </Pressable>
          ))}
        </Card>
...
const styles = StyleSheet.create({
  ...
  row: { minHeight: 60, flexDirection: "row", alignItems: "center", justifyContent: "space-between", borderBottomWidth: 1, borderBottomColor: PHANX.line },
  label: { color: PHANX.ink, fontSize: 13, fontWeight: "800" },
  pressed: { opacity: 0.62 },
  note: { color: PHANX.muted, fontSize: 10, textAlign: "center", marginTop: 18, lineHeight: 16 },
});
