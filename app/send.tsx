    ...
    <ScreenContainer className="px-5" edges={["top", "left", "right"]}>
      <View style={styles.header}>
        <TouchableOpacity
          ...
          activeOpacity={0.7}
        >
          <MaterialIcons name="unfold-more" size={16} color={PHANX.ink} />
          <View>
        ...
        <TouchableOpacity onPress={() => router.back()} hitSlop={12} style={webCursor} activeOpacity={0.7}>
          <MaterialIcons name="chevron-left" size={26} color={PHANX.ink} />
        </TouchableOpacity>
      </View>
      ...
      >
        ...
        <View style={[styles.addressRow, addressValid && styles.addressRowValid]}>
          <TouchableOpacity
            ...
            activeOpacity={0.7}
          >
            <MaterialIcons name="qr-code-scanner" size={19} color={PHANX.muted} />
          </TouchableOpacity>
          <TouchableOpacity
            onPress={async () => {
              try {
            ...
            activeOpacity={0.7}
          >
            <MaterialIcons name="content-paste" size={19} color={PHANX.muted} />
          </TouchableOpacity>
          <TextInput
        ...
        <View style={styles.quickRow}>
          ...
          <TouchableOpacity onPress={() => setPercent(1)} style={webCursor} activeOpacity={0.7}>
            <Text style={[styles.pct, { color: PHANX.green }]}>MAX</Text>
          </TouchableOpacity>
        </View>
              ...
              {row.map((d) =>
                d === "back" ? (
                  <TouchableOpacity
                    ...
                    activeOpacity={0.65}
                  >
                    <MaterialIcons name="backspace" size={18} color={PHANX.ink} />
                  </TouchableOpacity>
                ) : (
                  <TouchableOpacity
                    key={d}
      ...
      {toast ? (
        <View style={styles.toast} pointerEvents="none">
          <MaterialIcons name="info-outline" size={18} color={PHANX.white} />
...
const styles = StyleSheet.create({
  ...
  networkLabel: { color: PHANX.muted, fontSize: 9, textAlign: "right" },
  networkValue: { color: PHANX.ink, fontSize: 13, fontWeight: "900", textAlign: "right" },
  ...
  currencyText: { color: PHANX.ink, fontSize: 17, fontWeight: "900" },
  sendLabel: { color: PHANX.muted, fontSize: 15 },
  amount: { color: "#B9C2BD", fontSize: 48, fontWeight: "800", textAlign: "center", marginTop: 10 },
  amountActive: { color: PHANX.ink },
  usdRow: { flexDirection: "row-reverse", justifyContent: "center", gap: 6, marginTop: 4 },
  usdValue: { color: PHANX.muted, fontSize: 13, fontWeight: "700" },
  usdLabel: { color: PHANX.muted, fontSize: 13 },
  addressRow: {
    flexDirection: "row-reverse",
    alignItems: "center",
    gap: 10,
  ...
  addressRowValid: { borderColor: PHANX.green },
  addressInput: { flex: 1, color: PHANX.ink, fontSize: 13, paddingVertical: 8 },
  addressLabel: { color: PHANX.muted, fontSize: 12 },
  quickRow: { flexDirection: "row-reverse", alignItems: "center", gap: 16, marginTop: 14 },
  pct: { color: PHANX.ink, fontSize: 12, fontWeight: "900", padding: 6 },
  balanceRow: {
    flexDirection: "row-reverse",
    justifyContent: "space-between",
    alignItems: "center",
  ...
  balanceText: { color: PHANX.ink, fontSize: 13, fontWeight: "900" },
  balanceLabel: { color: PHANX.muted, fontSize: 11 },
  ...
  opKeyActive: { backgroundColor: PHANX.green },
  opText: { color: PHANX.ink, fontSize: 20, fontWeight: "800" },
  opTextActive: { color: PHANX.white },
  ...
  digitText: { color: PHANX.ink, fontSize: 24, fontWeight: "700" },
  submit: {
  ...
  submitActive: { backgroundColor: PHANX.green },
  submitText: { color: PHANX.white, fontSize: 15, fontWeight: "900" },
  pressed: { opacity: 0.6 },
  toast: {
    position: "absolute",
    left: 20,
  ...
  toastText: { color: PHANX.white, fontSize: 13, fontWeight: "700", flex: 1, textAlign: "right" },
});
